...
(function ($) {
  ...
  if (!Object.keys) {
    ...
    if (Object && !Object.prototype.hasOwnProperty.call('selectedOptions')) {
        Object.defineProperty(Object.prototype, 'selectedOptions', {
      get: function () {
  ...
  Selectpicker.DEFAULTS = {
    ...
    maxOptionsText: function (numAll, numGroup) {
      return [
          (numAll == 1) ? '选中条件不能超过{n}条' : '选中条件不能超过{n}条',
          (numGroup == 1) ? '组选中条件不能超过{n}条' : '组选中条件不能超过{n}条'
      ];
    },
    selectAllText: '全选',
    deselectAllText: '取消',
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<button type="button" class="' + this.options.styleBase + ' btn-default dropdown-toggle" ' + (this.options.display === 'static' ? 'data-display="static"' : '') + 'data-toggle="dropdown"' + autofocus + ' role="button">' +
